  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          <h2>Modificar Diseño de Email</h2>
          <ol class="breadcrumb">
            <li><a href="home.php?seccion=inicio">Home</a></li>
            <li><a href="#">Diseño de Email</a></li>
            <li class="active"><strong>Modificar Diseño de Email</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form action="svDemail.php" method="post" enctype="multipart/form-data" name="form1">
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="titulo" id="titulo" class="form-control" value="<?php echo $arrCont["ed_titulo"] ?>">
                  </div>
                 ...
                 <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="avance" id="avance" class="form-control" value="<?php echo $arrCont["ed_avance"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <?php if ($arrCont["ed_imagen"]!="nd") { ?>
                      <div class="imagem-p">
                        <img src="../assets/imgmail/<?php echo $arrCont["ed_imagen"] ?>"  width="200" height="100%">
                      </div>
                      <label for="imagen">Nueva Imagen</label>
                      <input type="file" name="archivo" id="archivo" class="form-control form-file">
                      <input name="imagactual" type="hidden" value="<?php echo $arrCont["ed_imagen"] ?>">
                    <?php } else {?>
                      <input type="file" name="archivo" id="archivo" class="form-control form-file">
                    <?php } ?>
                  </div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <textarea name="textos1" rows="12" id="textos1"><?php echo $arrContt1["et_texto"] ?></textarea>
                  </div>
                  ...
                  <div class="hr-line-dashed col-xs-12"></div>
                   ...
                   <div class="form-group col-xs-6">
                    ...
                    <textarea name="textos2" rows="12" id="textos2"><?php echo $arrContt2["et_texto"] ?></textarea>
                  </div>

                    <!-- Texto -->
                    <div class="form-group col-xs-6">
                    <label for="textos3">Texto Secundario 2</label>
                    <textarea name="textos3" rows="12" id="textos3"><?php echo $arrContt3["et_texto"] ?></textarea>
                  </div>
                  ...
                  <div class="hr-line-dashed col-xs-12"></div>
                   ...
                   <div class="form-group col-xs-6">
                    ...
                    <textarea name="textos4" rows="6" id="textos4"><?php echo $arrContt4["et_texto"] ?></textarea>
                  </div>

                  <!-- Texto -->
                  <div class="form-group col-xs-6">
                    <label for="textos5">Texto Secundario 4</label>
                    <textarea name="textos5" rows="6" id="textos5"><?php echo $arrContt5["et_texto"] ?></textarea>
                  </div>
                  ...
                  <div class="form-group col-xs-12">
                    ...
                    <input type="text" name="url" id="url" class="form-control" value="<?php echo $arrCont["ed_url"] ?>">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
