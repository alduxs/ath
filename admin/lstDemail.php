...
//
$query = "SELECT * FROM email_disenio";
...
$query = "SELECT * FROM email_disenio ORDER BY ed_id DESC, ed_titulo ASC LIMIT ?,?";
	...
	<div id="wrapper">
		...
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-12">
					<h2>Listar Diseño de Email</h2>
					<ol class="breadcrumb">
						<li><a href="home.php?seccion=inicio">Home</a></li>
						<li><a href="#">Diseño de Email</a></li>
						<li class="active"><strong>Listar Diseño de Email</strong></li>
					</ol>
				</div>
			</div>
			<div class="wrapper wrapper-content animated fadeInRight">
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-content">
								<form name="frm" method="post" action="svDemail.php">
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
													...
													<td><?php echo $arrContenido["ed_titulo"]; ?></td>
													
													<td class="tooltip-demo">
														<a href="mail.php?seccion=disenioemail&id=<?php echo $arrContenido["ed_id"]; ?>&intPage=<?php echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar" target="_blank"><i class="fa fa-search"></i></a>
														<a href="updDemail.php?seccion=disenioemail&id=<?php echo $arrContenido["ed_id"]; ?>&intPage=<?php echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript:;" onclick="delRegistro('<?php echo $arrContenido["ed_id"]?>','','disenioemail',<?php echo $intPage ?>);" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Borrar"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
												<?php $intCounter++; ?>
											<?php } ?>
				...
				<div class="row">
					<div class="col-lg-12 paginador">
						<?php echo printPaginado("lstDemail.php", $intQtyPages, $intPage, "disenioemail");?>
					</div>
				</div>
			</div>
			<div class="footer">
