                    ...
                    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
                        ...
                        <tr>
                            <td style="background-color: #5A6C60;text-align:center;" class="darkmode-bg">
                                <h2 style="color: #e9dfd4;font-size:40px;font-weight:700;font-family: sans-serif;">Now open for bookings</h2>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="background-color: #ffffff;" class="darkmode-bg">
                                <img src="<?php echo _CONST_DOMINIO_; ?>/assets/imgmail/img-muestra.jpg" width="600" height="" alt="alt_text" border="0" style="width: 100%; max-width: 600px; height: auto; background: #5A6C60; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555; margin: auto; display: block;" class="g-img">
                            </td>
                        </tr>
                    ...
                    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
                        ...
                        <tr>
                            <td style="padding: 10px; background-color: #E9DFD4;border:2px solid #ef7c41" class="darkmode-bg">
                                            ...
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-family: sans-serif; font-size: 14px; line-height: 15px; color: #384f40; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                                                        <h3>LIMITED SPOTS:</h3>
                                                        <p>M16th – 20th March 2024</p>
                                                        <p>20th – 24th March 2024</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </th>
                                        ...
                                        <th valign="top" width="40%" class="stack-column-center">
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-family: sans-serif; font-size: 14px; line-height: 15px; color: #384f40; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                                                        <h3>INCLUSIONS:</h3>
                                                        <p>4 nights’ accommodation & all meals and drinks - transfers from Taupo, four day’s guided hunting, use of firearms, and field preparation of trophies.</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </th>
                                        ...
                                        <th valign="top" width="40%" class="stack-column-center">
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-family: sans-serif; font-size: 14px; line-height: 15px; color: #384f40; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                                                        <h3>SINGLE HUNTER:</h3>
                                                        <p>$4850 USD + trophy fee $395 USD per night for non-hunter, sharing accommodation with hunter</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </th>
                                        ...
                                        <th valign="top" width="40%" class="stack-column-center">
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-family: sans-serif; font-size: 14px; line-height: 15px; color: #384f40; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                                                        <h3>TWO HUNTER:</h3>
                                                        <p>(Twin share, 2x1 guiding) $3050 USD + trophy fee (per hunter) $395 USD per night for non-hunter, sharing accommodation with hunter</p>
                                                    </td>
                                                </tr>
                                            </table>
                                        </th>
                                ...
                                <table >
                                    <tr>
                                        <td style="padding: 20px 0px;"> <a href="#" style="font-family: sans-serif;color:#ef7c41;font-weight:700;font-size:16px;">BOOK NOW</a> </td>
                                    </tr>
                                </table>
            ...
            <tr>
                <td>
                    <div align="center" style="max-width: 600px; margin: auto; border-bottom: 2px solid #d5d5ce;" class="email-container">
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px 0px; text-align: left; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #ffffff;">
                                ...
                                <td style="padding: 20px 0px; text-align: right; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #ffffff;">
            ...
            <tr>
                <td>
                    <div align="center" style="max-width: 600px; margin: auto; " class="email-container">
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px 0px; text-align: left; font-family: sans-serif; font-size: 14px; line-height: 20px; color: #000000;">
                                    <p>© 2023 ATH</p>
                                </td>

                                <td style="padding: 20px 0px; text-align: right; font-family: sans-serif; font-size: 14px; line-height: 20px; color: #000000;">
