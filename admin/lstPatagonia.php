...
$query = "SELECT * FROM patagonia ORDER BY id ASC, titulo ASC LIMIT ?,?";
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-12">
					...
					<ol class="breadcrumb">
						...
						<li><a href="#">PDF</a></li>
						<li class="active"><strong>Listar PDF</strong></li>
					</ol>
				</div>
			</div>
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
                                                    ...
                                                    <td> <a href="../assets/files/<?php echo $arrContenido["pdf"]; ?>" target="_blank"> <?php echo $arrContenido["pdf"]; ?></a></td>

													<td><?php if ($arrContenido["publicado"] == 0) { ?><a href="#" class="btn btn-default btn-circle"><i class="fa fa-check"></i></a><?php } else { ?><a href="#" class="btn btn-info btn-circle"><i class="fa fa-check"></i></a><?php } ?></td>
													
													<td class="tooltip-demo">
														
														<a href="updPatagonia.php?seccion=patagonia&id=<?php echo $arrContenido["id"]; ?>&intPage=<?php echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
