...
//
$query = "SELECT * FROM elpunto_espacios";
...
$query = "SELECT * FROM elpunto_espacios ORDER BY esp_nombre ASC, esp_id ASC LIMIT ?,?";
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><strong>Listar espacios</strong></li>
					</ol>
				</div>
			</div>
			<div class="wrapper wrapper-content animated fadeInRight">
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-content">
								<form name="frm" method="post" action="svEspacios.php">
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
													...
													<td><?php echo $arrContenido["esp_nombre"]; ?></td>
                                                    <td><?php echo $arrContenido["esp_hash"]; ?></td>
													
													<td class="tooltip-demo">
														<a href="updEspacios.php?seccion=espacios&id=<?php echo $arrContenido["esp_id"]; ?>&intPage=<?php echo $intPage ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
														<a href="javascript:;" onclick="delRegistro('<?php echo $arrContenido["esp_id"]?>','','espacios',<?php echo $intPage ?>);" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Borrar"><i class="fa fa-trash-o"></i></a>
													</td>
												</tr>
												<?php $intCounter++; ?>
											<?php } ?>
				...
				<div class="row">
					<div class="col-lg-12 paginador">
						<?php echo printPaginado("lstEspacios.php", $intQtyPages, $intPage, "espacios");?>
					</div>
				</div>
			</div>
			<div class="footer">
