                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p5b">
                                                                                        <h2 style="color: #e9dfd4; line-height: 120%; font-size: 35px;"><?php echo $arrCont["ed_titulo"]; ?></h2>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image es-p10t" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="<?php echo _CONST_DOMINIO_; ?>/assets/imgmail/<?php echo $arrCont["ed_imagen"] ?>" alt style="display: block;" width="560"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
