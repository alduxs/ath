...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #E9DFD4;" class="email-bg">
    <center role="article" aria-roledescription="email" lang="en" style="width: 100%; background-color: #E9DFD4;" class="email-bg">
        <!--[if mso | IE]>
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #E9DFD4;" class="email-bg">
    <tr>
    <td>
    <![endif]-->
        ...
        <div style="max-height:0; overflow:hidden; mso-hide:all;" aria-hidden="true">
            '.html_entity_decode($arrCont["ed_avance"]).'
        </div>
                    ...
                    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
                        ...
                        <tr>
                            <td style="padding: 20px 0; text-align: center">
                                <img src="http://argentinatophunts.com//assets/imgmail/logo-top.png" width="200" height="63" alt="alt_text" border="0" style="height: auto; background: #E9DFD4; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                            </td>
                        </tr>
                        <!-- Email Header : END -->
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #5A6C60;" class="darkmode-fullbleed-bg">
            <tr>
                <td style="background-image: url(\'http://argentinatophunts.com/assets/imgmail/fondo-imagen.jpg\');background-repeat: repeat-x;background-position: center bottom;">
                    <!-- Email Body : BEGIN -->
                    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="email-container">
                        <!-- Email Header : BEGIN -->
                        ...
                        <tr>
                            <td style="background-color: #5A6C60;text-align:center;" class="darkmode-bg">
                                <h2 style="color: #e9dfd4;font-size:26px;font-weight:700;font-family: sans-serif;">'.$arrCont["ed_titulo"].'</h2>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="background-color: #ffffff;" class="darkmode-bg">
                                <img src="http://argentinatophunts.com/assets/imgmail/'.$arrCont["ed_imagen"].'" width="600" height="" alt="alt_text" border="0" style="width: 100%; max-width: 600px; height: auto; background: #5A6C60; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555; margin: auto; display: block;" class="g-img">
                            </td>
                        </tr>
                            ...
                            <td style="padding: 10px; background-color: #E9DFD4;border:2px solid #ef7c41" class="darkmode-bg">
                                    ...
                                    <tr>
                                            ...
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                <tr>
                                                    <td style="padding: 10px; text-align: center">
                                                        <img src="http://argentinatophunts.com//assets/imgmail/ico-calendario.png" width="30" height="30" alt="alt_text" border="0" style="width: 100%; max-width: 30px; height: auto; background: #E9DFD4; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                                                    </td>
                                                </tr>
                                            ...
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-family: sans-serif; font-size: 14px; line-height: 15px; color: #384f40; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                                                        '.html_entity_decode($arrContt2["et_texto"]).'
                                                    </td>
                                                </tr>
                                            </table>
                                        </th>
                                        ...
                                        <th valign="top" width="10%" class="stack-column-center">
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                <tr>
                                                    <td style="padding: 10px; text-align: center">
                                                        <img src="http://argentinatophunts.com//assets/imgmail/ico-time.png" width="30" height="30" alt="alt_text" border="0" style="width: 100%; max-width: 30px; height: auto; background: #E9DFD4; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                                                    </td>
                                                </tr>
                                        ...
                                        <th valign="top" width="40%" class="stack-column-center">
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-family: sans-serif; font-size: 14px; line-height: 15px; color: #384f40; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                                                    '.html_entity_decode($arrContt3["et_texto"]).'
                                                    </td>
                                                </tr>
                                            </table>
                                        </th>
                                    ...
                                    <tr>
                                        ...
                                        <th valign="top" width="10%" class="stack-column-center">
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                <tr>
                                                    <td style="padding: 10px; text-align: center">
                                                        <img src="http://argentinatophunts.com//assets/imgmail/ico-dinero.png" width="30" height="30" alt="alt_text" border="0" style="width: 100%; max-width: 30px; height: auto; background: #E9DFD4; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
                                                    </td>
                                                </tr>
                                        ...
                                        <th valign="top" width="40%" class="stack-column-center">
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-family: sans-serif; font-size: 14px; line-height: 15px; color: #384f40; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                                                    '.html_entity_decode($arrContt4["et_texto"]).'
                                                    </td>
                                                </tr>
                                            </table>
                                        </th>
                                        ...
                                        <th valign="top" width="40%" class="stack-column-center">
                                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-family: sans-serif; font-size: 14px; line-height: 15px; color: #384f40; padding: 0 10px 10px; text-align: left;" class="center-on-narrow">
                                                    '.html_entity_decode($arrContt5["et_texto"]).'
                                                    </td>
                                                </tr>
                                            </table>
                                        </th>
                                ...
                                <table >
                                    <tr>
                                        ...
                                        if($arrCont["ed_url"] != "") {
                                            $cuerpo .= '<a href="'.$arrCont["ed_url"].'" style="font-family: sans-serif;color:#ffffff;font-weight:700;font-size:16px;background-color: #ef7c41;padding: 10px 15px;border-radius: 5px;">BOOK NOW</a> ';
                                        } else {
                                ...
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td style="padding: 20px 0px; text-align: center; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #ffffff;">
                                            <img src="http://argentinatophunts.com/assets/imgmail/logo-top.png" width="150" height="auto" alt="alt_text" border="0" style="height: auto; background: #f4efe9; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #f4efe9;">
                                        </td>
                                    </tr>
            ...
            <tr>
                <td>
                    <div align="center" style="max-width: 600px; margin: auto; " class="email-container">
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px 0px 20px 20px; text-align: left; font-family: sans-serif; font-size: 14px; line-height: 20px; color: #000000;">
                                    <p>&copy; 2023 ATH</p>
                                </td>

                                <td style="padding: 20px 20px 20px 0px; text-align: right; font-family: sans-serif; font-size: 14px; line-height: 20px; color: #000000;">
