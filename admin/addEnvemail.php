      ...
      <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><strong>Enviar Email</strong></li>
          </ol>
        </div>
      </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                <form method="post" action="svEnvemail.php" enctype="multipart/form-data" name="form1">
                  ...
                  <div class="hr-line-dashed col-xs-12"></div>
                   ...
                   <!-- Notas relacionadas -->
                   <div class="form-group col-xs-12">
                    <label for="demail">Diseño de E-mail</label>
                    <select name="demail" class="select2_demo_3 form-control" id="demail">

                      <option value="0"></option>
                      <?php
                      $queryPost = "SELECT * FROM email_disenio";
                      $rsPost = $objContenido->getAllContenido($link, $queryPost);
                      ?>
                      <?php while ($arrPost = $rsPost->fetch(PDO::FETCH_BOTH)) { ?>
                        <option value="<?php echo $arrPost["ed_id"] ?>"><?php echo $arrPost["ed_titulo"] ?></option>
                      <?php } ?>
                    </select>
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
                  ...
                  <!-- Nombre destinatario -->
                 <div class="form-group col-xs-12">
                    <label for="ndest">Nombre destinatario</label>
                    <input type="text" name="ndest" id="ndest" class="form-control">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>

                   <!-- Nombre destinatario -->
                 <div class="form-group col-xs-12">
                    <label for="emaildest">E-mail destinatario</label>
                    <input type="text" name="emaildest" id="emaildest" class="form-control">
                  </div>
                  <div class="hr-line-dashed col-xs-12"></div>
