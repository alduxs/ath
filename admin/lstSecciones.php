...
$arrData = [['value'=> $page,'tipo'=> 'NU']];
$query = "SELECT * FROM secciones WHERE seccion_id_pagina = ? ORDER BY seccion_id ASC";
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-12">
					...
					<ol class="breadcrumb">
						...
						<li class="active"><strong>Listar secciones</strong></li>
					</ol>
				</div>
			</div>
										...
										<tbody>
											...
											<?php while ($arrContenido = $rsCont->fetch(PDO::FETCH_BOTH)) { ?>
												<tr>
													...
													<td><?php echo $arrContenido["seccion_nombre"]; ?></td>
								
													<td class="tooltip-demo">
														<a href="updSeccion.php?seccion=<?php echo $seccion; ?>&page=<?php echo $page; ?>&seccionpage=<?php echo $arrContenido["seccion_id"]; ?>" class="btn btn-primary btn-bitbucket" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil"></i></a>
