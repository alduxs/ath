...
<script>
  ...
  gtag('config', 'AW-11201163425');
    ...
    <title>Chischaca Lodge | Argentina Top Hunts</title>
    <!-- Mete tags -->
    <meta content="Chischaca Lodge | Argentina Top Hunts" name="title" />
    ...
    <!-- Facebook -->
    <meta property="og:title" content="Chischaca Lodge | Argentina Top Hunts">
    ...
    <!-- Estilos Custom -->
    <link href="assets/css/chischaca.css?v=5" rel="stylesheet">
...
<div id="html5Loader">
    ...
    <div class="contenedor-total">
                    ...
                    <div class="col-md-6 p-0">
                        ...
                        <div class="info">
                            ...
                            <div class="texto">
                                ...
                                <p>TARGET SPECIES <span class="small">Red stag, fallow deer, axis deer, water buffalo, black buck, mouflon sheep, four hornerd sheep, wild boar</span></p>
                                <p>HUNTING METHOD <span class="small">Stalk or blind</span></p>
                                <p>ACCOMMODATION AND SERVICES<br>
                                    <span class="small">Accommodation: 3 master suites and 3 double rooms with private bathrooms with a capacity of up to 12 people.</span><br>
        ...
        <section class="seccion2video" id="video">
            <video controls loop width="100%" height="auto" id="video3" poster="assets/video/chischaca.jpg">
                <source src="assets/video/chischaca.mp4" type="video/mp4">
        ...
        <section class="seccion3">
            ...
            <div class="bloque2">
                <h1>LOCATION</h1>
                <div class="maparep"> <img src="assets/images/chischaca/page/mapa01-resp.png" alt=""> </div>
            </div>
                ...
                <div class="row cuadricula-g">
                    ...
                    <div class="col-md-12 col-lg-6">
                        <div class="row cuadricula-int">
                            <div class="col-md-12 col-lg-12 p-0" style="background-image: url('assets/images/chischaca/page/lodge02.jpg');background-repeat:no-repeat;background-size:cover;background-position:center;">
                            </div>
                            <div class="col-md-12 col-lg-12 p-0" style="background-image: url('assets/images/chischaca/page/lodge03.jpg');background-repeat:no-repeat;background-size:cover;background-position:center top;">
                            </div>
                        </div>
                    </div>

                    <div class="col-md-12 col-lg-6 p-0" style="background-image: url('assets/images/chischaca/page/lodge04.jpg');background-repeat:no-repeat;background-size:cover;background-position:center bottom;">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-4 plato">
                        <div class="plato-g">
                            <div class="plato1" style="background-image: url('assets/images/chischaca/page/plato.png');background-repeat:no-repeat;background-position:center;"></div>
                            <div class="plato2" style="background-image: url('assets/images/chischaca/page/plato02.png');background-repeat:no-repeat;background-position:center;"></div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="bloquet">
                            <h1>OUR CHEFS</h1>
                            <p>Our chefs share the same philosophy of gastronomy marked by their love for the traditional simple Argentine cuisine, taken to the highest level, specializing in the preparation of the hunting game.</p>
                        </div>

                    </div>
                    <div class="col-md-4 chef" style="background-image: url('assets/images/chischaca/page/chef.jpg');background-repeat:no-repeat;background-position:center top;">

                        <div class="nombre-chef">
                            Flavio, Chischaca’s chef
                        </div>
